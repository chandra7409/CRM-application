...
async function init() {
    ...
    try {
        ...
        user = await User.create({
            name: "Tilak",
            userId: "admin7409", // It should be atleat 16, else will throw error
            email: "ErTilakchandra@gmail.com", // If we don't pass this, it will throw the error
            userType: "ADMIN",
            password: bcrypt.hashSync("Asus7409", 8) //this field should be hidden from the end user
